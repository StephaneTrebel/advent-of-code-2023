...
a *prediction of the next value* in each history. To do this, start by making
...
filling in the next values of each previous sequence, you should instead add
a zero to the *beginning* of your sequence of zeroes, then fill in new *first*
